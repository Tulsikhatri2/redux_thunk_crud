...
function Navbar() {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <div className="hidden w-full md:block md:w-auto">
      ...
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-black-100 
      ...
      md:border-0 md:bg-white dark:bg-black md:dark:bg-black-900 dark:border-black-700">
        ...
        <li>
          <Link to="/table" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 
